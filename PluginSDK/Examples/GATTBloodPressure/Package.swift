...
//
//   swift build -c release --swift-sdk swift-6.3.3-RELEASE_wasm-embedded --product GATTBloodPressure
//
import PackageDescription

let package = Package(
    name: "GATTBloodPressure",
    products: [
        .executable(name: "GATTBloodPressure", targets: ["GATTBloodPressure"])
    ],
    dependencies: [
