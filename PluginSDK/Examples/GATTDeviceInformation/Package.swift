...
//
//   swift build -c release --swift-sdk swift-6.3.3-RELEASE_wasm-embedded --product GATTDeviceInformation
//
import PackageDescription

let package = Package(
    name: "GATTDeviceInformation",
    products: [
        .executable(name: "GATTDeviceInformation", targets: ["GATTDeviceInformation"])
    ],
    dependencies: [
