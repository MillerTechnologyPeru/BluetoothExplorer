...
extension CharacteristicView {
    ...
    func canPerform(_ action: Action) -> Bool {
        ...
        switch action {
        case .read:
            return properties.contains(CharacteristicProperties.read)
        case .write:
            return properties.contains(CharacteristicProperties.write)
        case .writeWithoutResponse:
            return properties.contains(CharacteristicProperties.writeWithoutResponse)
        case .notify:
            return properties.contains(CharacteristicProperties.notify) || properties.contains(CharacteristicProperties.indicate)
        }
    }
