...
//
//   swift build -c release --swift-sdk swift-6.3.3-RELEASE_wasm-embedded --product GATTIndoorPositioning
//
import PackageDescription

let package = Package(
    name: "GATTIndoorPositioning",
    products: [
        .executable(name: "GATTIndoorPositioning", targets: ["GATTIndoorPositioning"])
    ],
    dependencies: [
